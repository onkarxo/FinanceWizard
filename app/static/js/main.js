    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchAndDisplayNews() {
            ...
            //const newsUrl = `https://newsapi.org/v2/everything?category=business&apiKey=${API_KEY}&pageSize=10`;
            const newsUrl = `https://newsapi.org/v2/everything?q=trading&apiKey=${API_KEY}&pageSize=15`;
